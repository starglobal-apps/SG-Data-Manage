...
var CACHE = 'sg-data-v6';
var SHELL = ['./', './index.html', './style.css', './app.js', './sheet.js', './home.js', './entry.js', './data.js', './modules.js', './config.js', './manifest.json', './icons/icon-192.png', './icons/icon-512.png'];
