...
var CACHE = 'sg-data-v18';
var SHELL = ['./', './index.html', './style.css', './app.js', './sheet.js', './home.js', './hourly.js', './data.js', './hour.js', './users.js', './pms.js', './report.js', './modules.js', './config.js', './manifest.json', './icons/icon-192.png', './icons/icon-512.png'];
